...
import com.example.ryan.RYANFAIZAL_1202154188_MODUL5.Model.Activity;
...
//membuat holder untuk mengeset text
    ...
    public void dismissData(int data){
        ActivityData db = new ActivityData(inflater.getContext());
