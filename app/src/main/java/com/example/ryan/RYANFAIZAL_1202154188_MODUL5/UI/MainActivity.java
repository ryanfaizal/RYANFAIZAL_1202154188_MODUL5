package com.example.ryan.RYANFAIZAL_1202154188_MODUL5.UI;
...
import com.example.ryan.RYANFAIZAL_1202154188_MODUL5.ActivityData;
import com.example.ryan.RYANFAIZAL_1202154188_MODUL5.R;
import com.example.ryan.RYANFAIZAL_1202154188_MODUL5.RecyclerAdapter;
import com.example.ryan.RYANFAIZAL_1202154188_MODUL5.Swipe;

import java.util.LinkedList;

public class MainActivity extends AppCompatActivity {

    private LinkedList<com.example.ryan.RYANFAIZAL_1202154188_MODUL5.Model.Activity> mActivity = new LinkedList<>();
    private int mCount = 0;

    private RecyclerView mRecyclerView;
    private RecyclerAdapter mAdapter;
    private ActivityData databaseHandler;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Check DB
        databaseHandler = new ActivityData(this);
    ...
    private void setRecyclerView() {
        ...
        ItemTouchHelper.Callback callback = new Swipe(mAdapter);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == 1){
            ...
            databaseHandler.save(new com.example.ryan.RYANFAIZAL_1202154188_MODUL5.Model.Activity(data.getStringExtra("activity"), data.getStringExtra("desc"), data.getStringExtra("priority")));
        }
        setRecyclerView();
